...
export default function SignInPage() { 
  ...
  const handleSubmit = (e: React.FormEvent) => { 
    ...
    // 3. Pindahkan halaman ke /user/dashboard
    router.push("/user/dashboard"); 
  }; 

  const handleGoogleClick = () => { 
    console.log("Lanjutkan dengan Google diklik"); 
    // Jika Google login juga ingin langsung ke dashboard:
    router.push("/user/dashboard");
  }; 

  const handleAppleClick = () => { 
    console.log("Lanjutkan dengan Apple diklik"); 
    // Jika Apple login juga ingin langsung ke dashboard:
    router.push("/user/dashboard");
  }; 
      ...
      <div className={styles.formSection}> 
        <div className={styles.formWrapper}> 
          ...
          <form onSubmit={handleSubmit} className={styles.form}> 
            ...
            {/* Tombol submit ini akan memicu fungsi handleSubmit */}
